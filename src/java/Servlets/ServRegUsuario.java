 ...
 * @author Gestionarweb
 */
public class ServRegUsuario extends HttpServlet {
  ...
  //creamos una sesion para guardar los datos del usuario que se loguea    
            ...
            FregUsuario fun = new FregUsuario();//funciones
            ...
            response.sendRedirect("../GestionarWeb.com/admin/Usuario.jsp?mes=" + "No");
            }
            ...
            try {
                ...
                if (fun.insertar(dts)) {//si los datos se insertan 
                    ...
                    if (rs.next()) {
                        ...
                        response.sendRedirect("../GestionarWeb.com/admin/Conf.jsp");
                    }
                } else {
                ...
                out.println("<h3>" + e + "</h3>");
                response.sendRedirect("../GestionarWeb.com/admin/Usuario.jsp?mes=" + e);
            }
        }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServRegUsuario.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
