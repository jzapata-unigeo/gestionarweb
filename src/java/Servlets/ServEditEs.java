 ...
 * @author Jeison
 */
public class ServEditEs extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            dts.setNumDocumento(sec.getAttribute("cod").toString());
            String checkh = "";
            String checkm = "";
            ...
            if (rs.next()) {
                ...
                sec.setAttribute("nomuser", dts.getNomEstudiante() + " " + dts.getApllEstudiante());
            ...
            response.sendRedirect("user/Consulta_Ver.jsp");

            out.println("<!DOCTYPE html>");
            out.println("<html>");
            out.println("<head>");
            out.println("<title>Servlet ServEditEs</title>");
            out.println("</head>");
            out.println("<body>");
            out.println("<h1>Servlet ServEditEs at " + request.getContextPath() + "</h1>");
            out.println("</body>");
            out.println("</html>");
        }
    }
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(ServEditEs.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
