    ...
    <body>
        ...
        <div class="contenido">
            ...
            <div class="contenido1">
                <form class="contacto" action="../ServactualizaEst" method="post">
                    <ul>
                        <li>
                            <label for="tipoc">Documento:</label>
                            <select name="tipoc"  required>
s                                <option id="tipoc" name="tipoc" value="<%=tipdoc%>" readonly ><%=tipdoc%></option>
                            </select> 
        ...
        <%
            try {
                ...
                if (sec.getAttribute("mensajeu").equals("1")) {
