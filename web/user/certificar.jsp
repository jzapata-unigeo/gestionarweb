    ...
    <div id="print">
        <div class="contenido">
            ...
            <% try {
                ...
                sec1.getAttribute("notas");
                Vector notas = (Vector) sec1.getAttribute("notas");
                Vector mater = (Vector) sec1.getAttribute("materias");
                String idusuario = (String) sec1.getAttribute("idusuario");
                String nombre = (String) sec1.getAttribute("nombres");
                String anio = (String) sec1.getAttribute("anio");
                String semestre = (String) sec1.getAttribute("semestre");
                String ciclo = (String) sec1.getAttribute("ciclo");
                String jornada = (String) sec1.getAttribute("jornada");
                String tipdoc = (String) sec1.getAttribute("tipdoc");
                String numdoc = (String) sec1.getAttribute("numdoc");
                String aprobo = (String) sec1.getAttribute("aprobar");
                String idmatricula = (String) sec1.getAttribute("user");
